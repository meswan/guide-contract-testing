...
The [hotspot=state file=1]`@State` annotation must match the [hotspot=given file=2]`.given()` parameter that was provided in the inventory test class so that pact can identify which test case to run against.
